...
3. [Installation with **pip**](#installation-with-pip)  
   ...
   4. [User‑only install (no sudo)](#user-only-install-no-sudo)  
   5. [Virtual‑env best practice](#virtual-env-best-practice)  
4. [Optional extras (IO, Excel, HTML, …)](#optional-extras-io-excel-html)  
...
6. [Quick‑start helper module](#quick-start-helper-module)  
   ...
   2. [Example script that uses the helpers](#example-script-that-uses-the-helpers)  
7. [Reusable utilities (copy‑paste “cookbook”)](#example-script-that-uses-the-helpers)  
   * [IO & performance](#1-io-performance)  
   * [Data‑cleaning & type handling](#2-data-cleaning-types)  
   * [Joins & set operations](#3-joins-set-operations)  
   * [Aggregation, ranking & reshaping](#common-installation-issues-fixes)  
   * [Datetime & time‑series helpers](#5-datetime-time-series-helpers)  
   * [Outliers & binning](#6-outliers-binning)  
   * [Miscellaneous utilities](#7-miscellaneous-utilities)  
8. [Common install‑time issues & fixes](#next-steps-further-reading)  
9. [Advanced workflow tips](#advanced-workflow-tips)  
10. [Uninstall & clean‑up](#uninstall-clean-up)  
11. [FAQ](#faq)  
12. [Next steps & further reading](#next-steps-further-reading)
