...
> [!WARNING]
> **Project Archival Notice**: As of 2024, the official `neofetch` repository has been archived and is no longer maintained by its author. For active development, Apple Silicon hardware detection, and 10x-100x faster execution speeds, check out **[Fastfetch](?page=cli-tools%2Fsystem-monitoring%2Ffastfetch-system-info-guide)** (`brew install fastfetch`).
